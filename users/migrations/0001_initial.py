# Generated by Django 3.0.8 on 2020-08-19 21:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lat', models.DecimalField(blank=True, decimal_places=14, max_digits=16, null=True)),
                ('lng', models.DecimalField(blank=True, decimal_places=14, max_digits=16, null=True)),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
